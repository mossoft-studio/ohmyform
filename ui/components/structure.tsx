...
import { Alert, Dropdown, Layout, Menu, PageHeader, Select, Space, Spin } from 'antd'
  ...
  return (
    <Layout style={{ height: '100vh' }} className={'admin'}>
      ...
      >
        ...
        <Layout
          style={{ padding: '0 24px 24px', minHeight: 500, height: '100%', overflow: 'auto', background: "#E9ECF6" }}
        >
          {props.title && (
            <PageHeader
              title={props.title}
